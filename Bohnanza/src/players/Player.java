	...
	public void setTransaction() {
		...
		while(true) {
			...
			if(0<=tempOffer && tempOffer<openedBeans.size()) {
				if(!transaction.addToOffer(openedBeans.get(tempOffer))) System.out.println("You already added that bean to offer");
			}
			else if(tempOffer<0) break;
			else System.out.println("Invalid Bean Index");
		}
	...
	public void harvest() {
		...
		while(true) {
			...
			for(int i:candidates)
				System.out.print(fields.get(i-1)+" ");
			System.out.println();
